...
export default function Home() {
  ...
  return (
    <div className="App">
      <header className="App-header bg-lime-600 text-slate-50 text-center p-16">
        <h1 className="font-bold text-3xl">Sequoia Fabrica</h1>
        <h2 className="text-2xl">A San Francisco Community Workshop</h2>
      </header>

      <div className="About m-16">
          <h2 className="font-bold text-xl text-center">Upcoming Events</h2>
          <p className="m-4">Stay tuned for events as we get going!</p>
          ...
          <p className="m-4">Want to learn more about our space and hear updates on our search for a physical home? Join our mailing list!</p>
