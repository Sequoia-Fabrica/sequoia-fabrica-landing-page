  ...
  return (
    <div className="App bg-white_smoke">
      ...
      <div className="About m-16">
        ...
        <p className="m-4">We have a <a className="text-primary_blue hover:text-primary_blue-200" href="/docs/code_of_conduct">Code of Conduct</a> that is required reading for all members. Anyone involved either in classes or otherwise is expected to review this.</p>
      </div>
      <Footer />
    </div>
  )
