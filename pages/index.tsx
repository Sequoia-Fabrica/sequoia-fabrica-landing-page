  ...
  return (
    <div className="App bg-white_smoke">
      <header className="App-header bg-pigment_green-300 text-center p-16">
        <Logo />
        <br></br>
        <h1 className="text-tea_green">A San Francisco Community Workshop</h1>
      </header>

      <div className="About m-4 md:m-16">
        <h2 className="text-center">Upcoming Events</h2>
        <p className="md:m-4">Our events are visible on our <a className="text-primary_blue hover:text-primary_blue-200" href="https://www.meetup.com/sequoia-fabrica-community-workshop-and-classes/">Meetup page</a>.</p>
