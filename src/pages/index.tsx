    ...
    <div className="App">
      ...
      <div className="About m-4 max-w-screen-md mx-auto grid grid-cols-2 gap-4 p-8">
        <div className="col-span-2">
            <p>We are Sequoia Fabrica, a community makerspace in <a href={urlConstants.googleMaps}>San Francisco's Potrero Hill neighborhood</a>. We’re home to a wood and textile workshop, 3D printers and a laser cutter, electronics, crafts and fine arts stations. </p>
            <p>We are a volunteer-run non-profit, and host <a href={urlConstants.bookWhen}>classes, events and workshop hours</a> open to the public. </p>
            <p>We offer <Link href={'/docs/membership'}>memberships</Link> for makers, designers, and craftspeople who want to support our programs and access the space and equipment outside of classes. Want to teach a class or organize an event at Sequoia? Please <Link href="/docs/contact">contact us</Link>.</p>
            <hr/>
          </div>
        ...
        <div className="col-span-2 md:col-span-1">
          <h2>Donations</h2>
          <p>Please support makers of today and tomorrow with a <a href={urlConstants.openCollective}>donation</a>! We are a California Public Benefit Corporation and tax-exempt public charity under Section 501(c)(3). EIN: 93-4496044</p>
        </div>
        <div className="col-span-2 md:col-span-1">
