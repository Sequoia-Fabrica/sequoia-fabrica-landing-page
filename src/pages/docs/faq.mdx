...
If you'd like to see the space please [sign up for an event](https://bookwhen.com/sequoiafabrica). 
...
Sequoia Fabrica seeks to be a clean, safe environment with working tools, where members and visitors can focus on learning, sharing, and making things. 
