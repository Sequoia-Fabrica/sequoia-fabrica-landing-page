...
5. **Start Paying Dues**. Membership dues are accepted through <a href={urlConstants.bookWhenMembership} data-goatcounter-click={urlConstants.bookWhenMembership}>BookWhen</a>. *Do not start paying dues before completing the steps above!*
